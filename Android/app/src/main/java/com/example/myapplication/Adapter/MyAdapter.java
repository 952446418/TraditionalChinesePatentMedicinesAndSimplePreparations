...
//
//    public MyAdapter(List<String> list, Context context, Filter.FilterListener filterListener) {
//        this.list = list;
...
//        if (convertView == null) {
//            convertView = LayoutInflater.from(context).inflate(R.layout.activity_mysearchview, null);
//            holder = new ViewHolder();
//            holder.tv_ss = (TextView) convertView.findViewById(R.id.et_search);
